...
<div class="page-header">
    <h1>Rute Detail ke <?=$row->nama_sekolah?></h1>
    <h3>Alamat: <?=$row->alamat_sekolah?></h3>
</div>
<a href="?m=tempat_list" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-chevron-left"></span> Kembali Ke Halaman Utama</a><br><br>
<div class="clearfix" style="background: #eaeaea;">
    <div id="map"></div>
    <div id="right-panel">
...
<p class="help-block"><b>Bantuan: </b>Geser marker atau garis untuk mengubah rute</p>
<script>
